...
<div className="row d-flex justify-content-center align-items-center h-100">
  <div className="col-12 col-md-8 col-lg-6 col-xl-5">
    ...
    {/* BASIC CURRENT DATA STRATS FROM HERE */}
        ...
        <div className="form-outline mb-4">
          <input type="text" name="companyName" value={student.companyName} onChange={handleInputChange} id="id" className="form-control form-control-lg" />
          <label className="form-label" for="Id">Company Name</label>
        </div>


        <div className="form-outline mb-4">
          <input type="text" name="pkgAmt" value={student.pkgAmt} onChange={handleInputChange} id="id" className="form-control form-control-lg" />
          <label className="form-label" for="Id">Package Amount</label>
        </div>


        <div className="form-outline mb-4">
          <input type="text" name="ppo" value={student.ppo} onChange={handleInputChange} id="id" className="form-control form-control-lg" />
          <label className="form-label" for="Id">PPO</label>
        </div>
